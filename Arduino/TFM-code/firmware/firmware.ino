...
const char* TEMPserv2="http://ec2-3-213-93-135.compute-1.amazonaws.com:7896/iot/json?i=temp001&k=4jggokgpepnvsb2uv4s40d59ov";
const char* TEMPserv="http://ec2-3-213-93-135.compute-1.amazonaws.com:1026/v2/entities/urn:ngsi:Temp:001";

const char* HUMserv2="http://ec2-3-213-93-135.compute-1.amazonaws.com:7896/iot/json?i=hum001&k=4jggokgpepnvsb2uv4s40d59ov";
const char* HUMserv="http://ec2-3-213-93-135.compute-1.amazonaws.com:1026/v2/entities/urn:ngsi:Hum:001";

const char* CO2serv2="http://ec2-3-213-93-135.compute-1.amazonaws.com:7896/iot/json?i=co2001&k=4jggokgpepnvsb2uv4s40d59ov";
const char* CO2serv="http://ec2-3-213-93-135.compute-1.amazonaws.com:1026/v2/entities/urn:ngsi:CO2:001";  

const char* servidor="http://ec2-3-213-93-135.compute-1.amazonaws.com:7896/iot/json?i=fan001&k=4jggokgpepnvsb2uv4s40d59ov";
